...
public class ActivityLoaderActivity extends Activity {
	...
	private void startImplicitActivation() {
		...
		// createChooser())
		Intent chooserIntent =  Intent.createChooser(webIntent, "Selecciona navegador");
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        //Here we check this activity result work for this intent we send with this specifyc
        //Request code
        if(requestCode == GET_TEXT_REQUEST_CODE)
        {
            //Verify result is ok so we can work with it
